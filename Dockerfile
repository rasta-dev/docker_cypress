...
RUN apt-get update && apt-get install \
        gconf-service libnotify-dev xauth xvfb libgtk2.0-0 libasound2 libatk1.0-0 libc6 libcairo2 libcups2 \
        ...
        fonts-liberation libappindicator1 libnss3 lsb-release xdg-utils wget curl -y;
